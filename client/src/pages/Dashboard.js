    ...
    <div>
      ...
      <div className="card" style={{ marginTop: '40px' }}>
        <h3 style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          Greetings! {user?.username || 'Guest'} from Flame-Cloud Team
        </h3>
      ...
      {/* Stats Section */}
      <div className="features-mini-grid" style={{ marginTop: '30px' }}>
        <div className="feature-mini" style={{ textAlign: 'center', padding: '25px 20px' }}>
          <span className="feature-mini-icon" style={{ background: 'transparent', border: '2px solid #FF2E00', fontSize: '1.8rem', width: '60px', height: '60px', margin: '0 auto 15px' }}>
            <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="#FF2E00" strokeWidth="1.5">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
            </svg>
          </span>
          <h5 style={{ fontSize: '1.2rem', marginBottom: '5px' }}>99.9% Uptime</h5>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>Guaranteed server availability</p>
        </div>
        ...
        <div className="feature-mini" style={{ textAlign: 'center', padding: '25px 20px' }}>
          ...
          <h5 style={{ fontSize: '1.2rem', marginBottom: '5px' }}>24/7 Support</h5>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>Always here to help you</p>
        </div>
        ...
        <div className="feature-mini" style={{ textAlign: 'center', padding: '25px 20px' }}>
          ...
          <h5 style={{ fontSize: '1.2rem', marginBottom: '5px' }}>Global Network</h5>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>Servers worldwide</p>
        </div>
        ...
        <div className="feature-mini" style={{ textAlign: 'center', padding: '25px 20px' }}>
          ...
          <h5 style={{ fontSize: '1.2rem', marginBottom: '5px' }}>400+ Members</h5>
